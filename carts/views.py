...
def add_cart(request, product_id):
    ...
    product = Product.objects.get(id=product_id) # get the product items
...
def remove_cart(request, product_id, cart_item_id):
    ...
    try:
        if request.user.is_authenticated: # adding or subtracting product quantity from the cart item
